    ...
    <div class="container">
        <form action="#" method="post">
            <div class="login flex flex-col w-96 self-center py-2 ">
                <h1>Login</h1>
                <input class=" w-60 h-8 mb-8" type="email" placeholder="Enter Your Email ID" name="loginEmail" required>
                <input class=" w-60 h-8 mb-4 " type="password" placeholder="Enter Your Password" name="loginPassword" required>
